...
//                System.out.println(Conditional_Column.get(l).toString());
    ...
    {
        for(int i = 0; i < tables.get(a).Get_Column_Number();i++)
        {
            for(int j = 0; j < First_Table_Column_Name.size();j++)
            {
                if(tables.get(a).Get_Column_Name().get(i).equals(First_Table_Column_Name.get(j)))
                {
                    First_Table_Column_number.add(i);
                }
            }
        }
    }
    ...
    {
       for(int i = 0; i < tables.get(Sec_Table_Number).Get_Column_Number();i++)
        {
            for(int j = 0; j < Second_Table_Column_Name.size();j++)
            {
                if(tables.get(Sec_Table_Number).Get_Column_Name().get(i).equals(Second_Table_Column_Name.get(j)))
                {
                    Second_Table_Column_number.add(i);
                }
            }
        }
    }
